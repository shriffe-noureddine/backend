...
/*
    ...
    Step 3 :
        ...
        For the Orcs :
            - They attack with rage. If they attack an elf, Elf loose 50 life points.
            - Orc can use his power to become almost invincible. +20 defense points but -10 attack.
        
        For the Humans :
            - A Human attack normally. But when he only has his fists (no weapons), he just smash everyone and get a +5 attack bonus.
        ...
        They can use power only once.

        For the 'relous' : you can change how the game is designed.
